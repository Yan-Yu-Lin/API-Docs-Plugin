...
sequenceDiagram
    ...
    Note over C,A: Try OAuth 2.0 and OpenID Connectdiscovery endpoints in priority order
...
sequenceDiagram
    ...
    Note over C: Generate PKCE parametersInclude resource parameterApply scope selection strategy
