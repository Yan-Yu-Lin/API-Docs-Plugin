...
> **Note:** MCP focuses solely on the protocol for context exchange—it does not dictate
...
graph TB
    ...
    Server1["MCP Server 1(e.g., Sentry)"]
    Server2["MCP Server 2(e.g., Filesystem)"]
    Server3["MCP Server 3(e.g., Database)"]

    Client1 ---|"One-to-oneconnection"| Server1
    Client2 ---|"One-to-oneconnection"| Server2
    Client3 ---|"One-to-oneconnection"| Server3
```
