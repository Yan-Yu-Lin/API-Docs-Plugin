...
canonical-url: 'https://openrouter.ai/docs/guides/guides/distillation'
...
'og:image':
  type: url
  value: >-
    https://openrouter.ai/dynamic-og?title=Distillation&description=Ensure%20compliance%20with%20provider%20and%20model%20creator%20policies
'og:image:width': 1200
'og:image:height': 630
